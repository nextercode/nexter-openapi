# Nexter's OpenAPI Specification

This repository contains [OpenAPI specifications][openapi] for Nexter's API.
...
[expand]: https://nexter.io/docs/api/java#expanding_objects
